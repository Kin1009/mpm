...
// v1 v2:likely
void *CW_realloc(void *ptr, size_t size);

//=== Drawing and display ====================================================//

// v1:likely v2:likely
void CW_Bdisp_PutDisp_DD(void);
// v1 v2
void *CW_GetVRAMAddress(void);
// v1 v2
void *CW_Bdisp_AllClr_VRAM(void);
// v1:used v2:used
void CW_PrintMini(int *x, int *y, char const *str_multibyte, int mode,
    int xlimit /* -1 */, int p6_zero, int p7_zero, int fgcolor, int bgcolor,
    int writeflag, int p11_zero);
// v1:used v2:used
void CW_PrintMiniMini(int *x, int *y, char const *str_multibyte, int mode1,
    int color3bit, int mode2);
// v1 v2:likely
void CW_MMPrintRef(int *x, int *y, char const *str, int mode, int xmax,
    int margin_top, int margin_bottom, int fgcolor, int bgcolor, int p10_zero,
    int p11_zero);
// v1:likely v2:likely
void CW_MMPrint(int x, int y, char const *str, int mode, int xmax,
    int margin_top, int margin_bottom, int fgcolor, int bgcolor, int p10_zero,
    int p11_zero);
...
// v1:likely v2:likely
int CW_BFile_Remove(uint16_t const *path);
// v1:likely v2:likely
int CW_BFile_Rename(uint16_t const *oldpath, uint16_t const *newpath);
// v1:likely v2:likely
int CW_BFile_Create(uint16_t const *path, int type, int *size);
// v1:used v2:used
int CW_BFile_Open(uint16_t const *path, int mode);
// v1:used v2:used
int CW_BFile_Close(int fd);
// v1:used v2:used
int CW_BFile_Size(int fd);
// v1:likely v2:likely
int CW_BFile_Write(int fd, void const *data, int even_size);
// v1:used v2:used
int CW_BFile_Read(int handle, void *data, int size, int whence);
// v1:likely v2:likely
